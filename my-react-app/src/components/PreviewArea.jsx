...
export default function PreviewArea({
  ...
  return (
    <div className="preview-area">
      ...
      {isLoading && (
        <div className="loading-overlay">
          ...
          <div style={{ textAlign: 'center' }}>
            ...
            <p style={{ color: 'var(--text-accent)', fontSize: '11px', marginTop: '6px', fontFamily: 'monospace' }}>
          ...
          <div className="prompt-overlay">
            <div className="prompt-message">
              ...
              <p className="prompt-text">
                {isDemoMode 
                  ? "Gostaria de fazer alguma alteração? Nossa IA mapeou o ambiente e você pode personalizar elementos individualmente."
                  : "Render finalizado! Note que a IA manteve a perspectiva exata do seu print tridimensional."
                }
              </p>
            </div>
            <div className="prompt-actions">
              ...
              {isDemoMode ? (
                <button className="btn-prompt-yes" onClick={onEnterEditor}>
                  Alterar Elementos (Demo)
                </button>
              ) : (
                <button className="btn-prompt-yes" onClick={onEnterEditor} title="A personalização manual interativa está configurada para o ambiente demonstrativo">
                  Demonstrar Editor
                </button>
              )}
            </div>
      ...
      {/* 4. DEEP INTERACTIVE EDITOR STATE (DEMO) */}
      {phase === 'editor' && (
        <div className="preview-workspace">
          <div className="editor-image-wrapper">
            {/* If not in demo mode, notify user that we show the demo scene for the editor */}
            {!isDemoMode && (
              <div style={{
                position: 'absolute',
                top: '12px',
                ...
                Exibindo sala demonstrativa para ilustrar o mapeamento manual inteligente.
              </div>
            )}
            ...
            <img 
              src={isDemoMode 
                ? getRenderImage() 
                : (activeMaterial === 'camel_leather' ? `${baseUrl}assets/day_render_modified.png` : `${baseUrl}assets/day_render.png`)
              } 
              alt="Editor Mrender" 
              style={{ width: '100%', height: '100%', objectFit: 'cover' }}
            />

            {/* Interactive SVG overlay map */}
            <svg 
              viewBox="0 0 100 100" 
            ...
            {hoveredHotspot && (
              ...
              >
                {hoveredHotspot === 'sofa' && "Sofá • Mobiliário (Configurável)"}
        ...
        <div className="toolbar-info">
          ...
          {phase === 'editor' && (
            selectedObject 
              ...
              : "Modo de Edição Direta: Selecione um objeto clicando na imagem"
          )}
